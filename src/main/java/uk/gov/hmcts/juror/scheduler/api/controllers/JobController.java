...
public class JobController {
    ...
    @Autowired
    public JobController(JobService jobService, TaskService taskService, JobDetailsMapper jobDetailsMapper,
            ...
            @ApiResponse(responseCode = "200", description = "Found",
                content = {
                    @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                        schema = @Schema(implementation = JobDetails.class))}),
    ...
    @Operation(summary = "Enable Job", description = "Enables the specified Job, allowing it to be automatically "
        ...
        + ". I" + ".e ones with a Cron expression)",
        responses = {
            @ApiResponse(responseCode = "202", description = "Job Enabled"),
            @ApiResponse(responseCode = "422", description = "Business Validation Rule",
                content = {
                    @Content(mediaType = MediaType.APPLICATION_PROBLEM_JSON_VALUE,
                        schema = @Schema(anyOf = {NotAScheduledJobError.class, JobAlreadyEnabledError.class}))}),
            @ApiResponse(responseCode = "401", description = "Unauthorised",
                content = {
                    @Content(mediaType = MediaType.APPLICATION_PROBLEM_JSON_VALUE,
                        schema = @Schema(implementation = UnauthorisedError.class))}),
            ...
            @ApiResponse(responseCode = "500", description = "Internal Server Error",
                content = {
                    @Content(mediaType = MediaType.APPLICATION_PROBLEM_JSON_VALUE,
                        schema = @Schema(implementation = InternalServerError.class))})})
    public ResponseEntity<Void> enableJob(
        @Pattern(regexp = APIConstants.JOB_KEY_REGEX) @PathVariable(name = "job-key") @Valid String jobKey) {
    ...
    @Operation(summary = "Disable Job", description = "Disables the specified Job, allowing it to be automatically "
        ...
        responses = {
            ...
            @ApiResponse(responseCode = "422", description = "Business Validation Rule",
                content = {
                    @Content(mediaType = MediaType.APPLICATION_PROBLEM_JSON_VALUE,
                        schema = @Schema(anyOf = {NotAScheduledJobError.class, JobAlreadyDisabledError.class}))}),
            @ApiResponse(responseCode = "401", description = "Unauthorised",
                content = {
                    @Content(mediaType = MediaType.APPLICATION_PROBLEM_JSON_VALUE,
                        schema = @Schema(implementation = UnauthorisedError.class))}),
            ...
            @ApiResponse(responseCode = "500", description = "Internal Server Error",
                content = {
                    @Content(mediaType = MediaType.APPLICATION_PROBLEM_JSON_VALUE,
                        schema = @Schema(implementation = InternalServerError.class))})})
    public ResponseEntity<Void> disableJob(
        @Pattern(regexp = APIConstants.JOB_KEY_REGEX) @PathVariable(name = "job" + "-key") @Valid String jobKey) {
    ...
    @Operation(summary = "Updates Job Data", description = "Will update the specified Job with the details you "
        ...
        responses = {
            ...
            @ApiResponse(responseCode = "422", description = "Business Validation Rule",
                content = {
                    @Content(mediaType = MediaType.APPLICATION_PROBLEM_JSON_VALUE,
                        schema = @Schema(implementation = IncorrectPayloadForJobTypeError.class))}),
            @ApiResponse(responseCode = "500", description = "Internal Server Error",
                content = {
                    @Content(mediaType = MediaType.APPLICATION_PROBLEM_JSON_VALUE,
                        schema = @Schema(implementation = InternalServerError.class))})})
    public ResponseEntity<APIJobDetailsResponse> updateJob(
        @Pattern(regexp = APIConstants.JOB_KEY_REGEX) @PathVariable(name = "job-key") @Valid String jobKey,
        @RequestBody @Valid APIJobPatch jobPatch) {
        return ResponseEntity.ok(jobDetailsMapper.toAPIJobDetailsResponse(jobService.updateJob(jobKey, jobPatch)));
    }

    @GetMapping("/tasks")
    @PreAuthorize("hasAuthority('" + PermissionConstants.Job.VIEW + "')")
    @Operation(summary = "Get all the tasks for a Job", description = "Returns the tasks for a Job",
        responses = {
    ...
    @GetMapping("/status")
    @PreAuthorize(
        "hasAuthority('" + PermissionConstants.Job.VIEW + "') or hasAuthority('" + PermissionConstants.Job.VIEW_STATUS
            + "')")
    @Operation(summary = "Get the latest task for a Job", description = "Returns the latest task for a Job",
        responses = {
            @ApiResponse(responseCode = "200", description = "TaskEntity details found for this Job",
                content = {
                    @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
